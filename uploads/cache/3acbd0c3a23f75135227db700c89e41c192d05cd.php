  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-md-6 col-12 text-center">
        ...
        <article class="post">
          <div class="img-block">
            <img src="<?php echo get_the_post_thumbnail_url($blog[0]->ID); ?>" class="w-100" alt="">
          </div>
      ...
      <div class="col-lg-3 col-md-6 col-12">
        <div class="contacts py-3">
          ...
          <div class="social-block d-flex">
            <a href='<?php echo the_field('инстаграм_link','options'); ?>'><img src='<?php echo get_template_directory_uri(); ?>/assets/images/small_instagran.png' alt='1'></a>
            <a href='<?php echo the_field('телеграм_link','options'); ?>'><img src='<?php echo get_template_directory_uri(); ?>/assets/images/small_telegram.png ' alt='3'></a>
            <a href='<?php echo the_field('viber_link','options'); ?>'><img src='<?php echo get_template_directory_uri(); ?>/assets/images/small_viber.png' alt='2'></a>
          </div>
        </div>
      </div>
    </div>
