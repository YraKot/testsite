  ...
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title"><?php pll_e('Форма заказа','sage'); ?></h4>
                ...
                <form action="<?php echo home_url().'/file-upload' ?>" method="POST" enctype="multipart/form-data">
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="form-group comment-form">
                        <label for="phone_question"><?php echo pll_e('Номер телефона','sage'); ?></label>
                        <input type="text" value="" name="phone_question">
                      </div>

                      <div class="form-group comment-form">
                        <label for="email_question"><?php echo pll_e('Ваш e-mail','sage'); ?></label>
                        <input type="email" value="" name="email_question">
                      </div>

                      <div class="form-group comment-form">
                        <label for="vid_raboti"><?php echo pll_e('Вид работы','sage'); ?></label>
                      ...
                      <div class="form-group comment-form">
                        <label for="name_question"><?php echo pll_e('Тема работы','sage'); ?></label>
                        <input type="text" value="" name="topic_work">
                      </div>

                      <div class="form-group comment-form">
                        <label for="name_question"><?php echo pll_e('Предмет','sage'); ?></label>
                        <input type="text" value="" name="predmet">
                      </div>

                      <div class="form-group comment-form">
                        <label for="name_question"><?php echo pll_e('Прикрепить файл','sage'); ?></label>
                        <div class="form-group files">
                          <input id="order_file" type="file" name="order_file" class="form-control" multiple>
                          <div class="file-name" style="display: none;">
                            <span id="clear_file" class="clear"><img src="<?= App\asset_path('images/clear_button.png'); ?>" alt=""></span>
                            <p class="name"></p>
                          </div>
                          <div class="img-block-file-upload">
                            <img src="<?= App\asset_path('images/upload.png'); ?>" alt="">
                            <p>Загрузите файл</p>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group comment-form">
                        <label for="name_question"><?php echo pll_e('Уникальность, %','sage'); ?></label>
                        <input type="text" value="" name="unique">
                      </div>
                      <div class="form-group comment-form">
                        <label for="name_question"><?php echo pll_e('Объем работы','sage'); ?></label>
                        <input type="text" value="" name="obiem_work">
                      </div>

                      <div class="form-group comment-form">
                        <label for="name_question"><?php echo pll_e('Дополнительная информация','sage'); ?></label>
