...
<div class="container custom-page mb-5 contactUs-page">
  <h1><?php echo pll_e('Контакты','sage'); ?></h1>
  <div class="row">
    <div class="col-md-6">
      <div style="width: 100%;height: 100%">
        <?php echo the_field('map','options'); ?>
    ...
    <div class="col-md-6">
      <div class="contacts py-3">
        ...
        <div class="social-block d-flex flex-column">
          <a href='<?php echo the_field('инстаграм_link','options'); ?>'><img src='<?php echo get_template_directory_uri(); ?>/assets/images/small_instagran.png' alt='1'>writer_works_for_students</a>
          <a href='<?php echo the_field('телеграм_link','options'); ?>'><img src='<?php echo get_template_directory_uri(); ?>/assets/images/small_telegram.png ' alt='3'>050 374 16 24</a>
          <a href='<?php echo the_field('viber_link','options'); ?>'><img src='<?php echo get_template_directory_uri(); ?>/assets/images/small_viber.png' alt='2'>050 374 16 24</a>
        </div>
